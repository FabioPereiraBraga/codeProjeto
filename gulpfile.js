...
config.bower_path_js = config.build_path+'/js';
config.build_vendor_path_js = config.bower_path_js+'/vendor';
...
config.bower_path_css = config.build_path+'/css';
config.build_vendor_path_css = config.bower_path_css+'/vendor';
...
gulp.task('copy-styles',function(){
    ...
    ]).pipe(gulp.dest(config.bower_path_css))
      .pipe(liveReload());
...
gulp.task('copy-scripts',function(){
    ...
    ]).pipe(gulp.dest(config.bower_path_js))
      .pipe(liveReload());
...
gulp.task('default',['clear-build-folder'] , function(){
    ...
    gulp.start('copy-html','copy-font' , 'copy-images');
    elixir(function(mix){
...
gulp.task('watch-dev',['clear-build-folder'],function(){
    liveReload.listen();
    gulp.start('copy-styles','copy-scripts','copy-html','copy-font' , 'copy-images');
